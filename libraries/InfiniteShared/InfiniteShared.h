...
#define PATTERN_VARIABLE_SPEED_ROTATION_END 17
#define PATTERN_FLASHING_HEXAGONS 18
#define PATTERN_FLASHING_HEXAGONS_WARP 19
#define NUM_PATTERNS 20

#define DEFAULT_PATTERN PATTERN_ROTATING_PONG
